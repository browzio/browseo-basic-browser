...
namespace Organiser.Common.Classes
{
    public class FlexibleMessageBox
    {
        ...
        /// <param name="buttons">The buttons.</param>
        /// <returns>The dialog result.</returns>
        public static void Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons)
        {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                MenuItem mItem = new MenuItem() { Text = "Copy" };
                mItem.Click += FlexibleMessageBoxForm_Click;
                this.richTextBoxMessage.ContextMenu = new ContextMenu(new MenuItem[] { mItem });  
                ...
                this.FormClosed += FlexibleMessageBoxForm_FormClosed;
            ...
            private void FlexibleMessageBoxForm_FormClosed(object sender, FormClosedEventArgs e)
            {
                this.Dispose();
            }

            private void FlexibleMessageBoxForm_Click(object sender, EventArgs e)
            {
                if (!string.IsNullOrEmpty(richTextBoxMessage.SelectedText) && !string.IsNullOrWhiteSpace(richTextBoxMessage.SelectedText))
                    MyFilesDatabase.SetClipboardText(richTextBoxMessage.SelectedText);
            }
