...
namespace Organiser.Common.Classes
{
    ...
    public class MozscapeLinkMetric
    {
        ...
        public string pmrr { get; set; }

        public string utrp { get; set; }

        public string utrr { get; set; }

        public string ftrp { get; set; }

        public string ftrr { get; set; }

        public string ptrr { get; set; }

        public string ptrp { get; set; }

        public string ued { get; set; }
