namespace Xilium.CefGlue.WindowsForms
{
    ...
    {
        public event Action HandleWasCreated = delegate { };
        public event Action<int> OnContextMenuItemClicked = delegate { };
        public void OnContextMenuItemSelected(int menuItemID)
        {
