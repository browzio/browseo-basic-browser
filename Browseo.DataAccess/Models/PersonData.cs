...
using Browseo.Browser.Framework.Extension;
...
namespace Browseo.Browser.Models
{
    [Serializable]
        ...
        public List<PersonData> Profiles
        {
            get
            {
                ...
                foreach (var item in new DirectoryInfo(ProjectDir).GetDirectories())
                {
                    ...
                    PersonData pnamefromFile = ProjectDataFilesReader.GetProjectOrProfilePersonData(item.FullName);
